...
const REVEAL_CONTENT = [
  {
    upper: ["McAelan Remigio", "Data Science • Statistics @ SDSU"],
    lower: "Strategy • Operations • Leadership",
  },
  {
    upper: [
...
const ROLES = [
  { text: "#1", color: "#e8c100", bg: "rgba(232,193,0,0.12)", border: "rgba(232,193,0,0.5)" },
  { text: "#2",  color: "#4a8fff", bg: "rgba(74,143,255,0.12)", border: "rgba(74,143,255,0.5)" },
  { text: "#3",  color: "#4a8fff", bg: "rgba(74,143,255,0.12)", border: "rgba(74,143,255,0.5)" },
];

const ITEMS = [
  {
    id: "Me", label: "About Me", handle: "@mcaelan", href: "https://www.linkedin.com/in/mcaelan/", icon: "💼", barIcon: icon1, bars: 1, newBars: [0], counts: ["56"],
    links: ["https://www.linkedin.com/in/mcaelan/"],
    stats: [
  ...
  {
    id: "DS", label: "Data Summary", handle: "@mcaelanremigio", href: "https://medium.com/@mcaelanremigio", icon: "✍️", barIcon: icon2, bars: 5, newBars: [1, 2], counts: ["3.4M", "2.5M", "676K", "412K", "198K"],
    links: ["https://medium.com/@mcaelanremigio"],
    stats: [
  ...
  {
    id: "Lead", label: "Leader", handle: "@mcaelan", href: "https://app.joinhandshake.com/profiles/mcaelan", icon: "🎓", barIcon: icon3, bars: 7, newBars: [0, 3, 5, 6], counts: ["5.1M", "3.7M", "2.2M", "1.4M", "831K", "490K", "217K"],
    links: ["https://app.joinhandshake.com/profiles/mcaelan"],
    stats: [
