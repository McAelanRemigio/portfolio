...
const ITEMS = [
  ...
  { id: "github",  label: "GITHUB",   href: "https://github.com/McAelanRemigio",  fontSize: 68, offsetX: 8, offsetY: 6,  skew: 0, skewY: -4  },
...
export default function P3Menu({ onNavigate }) {
  ...
  useEffect(() => {
    const onKey = (e) => {
      ...
      if (e.key === "Enter") handleItemSelect(ITEMS[active]);
    };
