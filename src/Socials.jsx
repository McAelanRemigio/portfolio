...
const ROLES = [
  ...
  { text: "Read",  color: "#4a8fff", bg: "rgba(74,143,255,0.12)", border: "rgba(74,143,255,0.5)" },
  { text: "Connect",  color: "#4a8fff", bg: "rgba(74,143,255,0.12)", border: "rgba(74,143,255,0.5)" },
];
...
const ITEMS = [
  {
    ...
    label: "LINKEDIN",
    handle: "@mcaelan",
    href: "https://linkedin.com/in/mcaelan",
    icon: "💼",
    barIcon: icon1,
    newBars: [0],
    counts: ["328"],
    stats: [
      ...
      { tag: "CON", value: "1.0K", color: "#bf94ff" },
    ],
  },
  {
    id: "medium",
    label: "MEDIUM",
    handle: "@mcaelanremigio",
    href: "https://medium.com/@mcaelanremigio",
    icon: "✍️",
    barIcon: icon2,
    newBars: [1, 2],
    counts: ["3.4M", "2.5M", "676K", "412K", "198K"],
    stats: [
      { tag: "VIEWS", value: "228", color: "#e1306c" },
      { tag: "READS", value: "145", color: "#f77737" },
    ],
  },
  {
    id: "handshake",
    label: "HANDSHAKE",
    handle: "@mcaelan",
    href: "https://app.joinhandshake.com/profiles/mcaelan",
    icon: "🎓",
    barIcon: icon3,
    newBars: [0, 3, 5, 6],
    counts: ["5.1M", "3.7M", "2.2M", "1.4M", "831K", "490K", "217K"],
    stats: [
      { tag: "APPS", value: "252", color: "#00f2ea" },
    ],
  },
];
